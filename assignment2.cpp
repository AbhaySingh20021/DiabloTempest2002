...
class list: public Node{
	...
	Node *startptr, *temp;
		...
		cout<<"\n";
			 ...
			 temp = startptr;
        cout << "\nLINKED LIST\n";
        while (temp->nxt!=startptr)
        {
            cout <<temp->data<<" -> ";
            temp = temp->nxt;
        } 
		cout<<temp->data<<" -> "<<temp->nxt->data<<"(HEAD )\n"; 
		}
